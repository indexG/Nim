...
NTI208578.base = NTI44042;
var NNI47862 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI47862.node = NNI47862;
NTI47862.base = NTI47828;
var NNI206074 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI44006, name: "Field0", sons: null}, 
...
function to_toc_207688(x_207690, father_207691) {
	...
	framePtr = F;
		...
		L12: do {
			...
			if (!((idx_207788 != null ? idx_207788.length : 0) == 2)) Tmp15 = false; else {				Tmp15 = (x_207690.childNodes[idx_207788[chckIndx(1, 0, idx_207788.length+0-1)-0]].nodeName == "UL");			}		if (Tmp15) {
		F.line = 164;
		var e_207829 = {heading: x_207690.childNodes[idx_207788[chckIndx(0, 0, idx_207788.length+0-1)-0]], kids: [], sortId: (father_207691.kids != null ? father_207691.kids.length : 0), doSort: false};
		F.line = 166;
		var it_207830 = x_207690.childNodes[idx_207788[chckIndx(1, 0, idx_207788.length+0-1)-0]];
		L16: do {
			F.line = 167;
			var j_207838 = 0;
			F.line = 2734;
			...
			L3: do {
				F.line = 2737;
					...
					if (!(i_208488 < colontmp__208487)) break L4;
						...
						i_207374 = i_208488;
						F.line = 84;
						if (items_207345[items_207345_Idx] != null) { items_207345[items_207345_Idx].push(x_207341.kids[chckIndx(i_207374, 0, x_207341.kids.length+0-1)-0].heading); } else { items_207345[items_207345_Idx] = [x_207341.kids[chckIndx(i_207374, 0, x_207341.kids.length+0-1)-0].heading]; };
						F.line = 2739;
				...
				L6: do {
					F.line = 2737;
						...
						if (!(i_208493 < colontmp__208492)) break L7;
							...
							i_207394 = i_208493;
							F.line = 87;
							var it_207395 = x_207341.kids[chckIndx(i_207394, 0, x_207341.kids.length+0-1)-0];
							F.line = 88;
			...
			L2: do {
				F.line = 4;
					...
					if (!(i_208510 < (kids_207024 != null ? kids_207024.length : 0))) break L3;
						F.line = 12;
						k_207056 = kids_207024[chckIndx(i_208510, 0, kids_207024.length+0-1)-0];
						F.line = 13;
			...
			L4: do {
				F.line = 2737;
					...
					if (!(i_208523 < colontmp__208522)) break L5;
						...
						i_207994 = i_208523;
						F.line = 198;
						var y_207995 = uncovered_207950(x_207952.kids[chckIndx(i_207994, 0, x_207952.kids.length+0-1)-0]);
						if (!((y_207995 == null))) {
						F.line = 199;
				...
				L2: do {
					F.line = 2737;
						...
						if (!(i_208517 < colontmp__208516)) break L3;
							...
							i_208054 = i_208517;
							F.line = 208;
							if (result_208033.kids != null) { result_208033.kids.push(news_208032.kids[chckIndx(i_208054, 0, news_208032.kids.length+0-1)-0]); } else { result_208033.kids = [news_208032.kids[chckIndx(i_208054, 0, news_208032.kids.length+0-1)-0]]; };
							F.line = 2739;
			...
			L2: do {
				F.line = 186;
					...
					if (!(i_208505 < l_208506)) break L3;
						F.line = 212;
						t_208214 = types_208079[chckIndx(i_208505, 0, types_208079.length+0-1)-0];
						F.line = 213;
							...
							L5: do {
								F.line = 186;
									...
									if (!(i_208502 < l_208503)) break L6;
										F.line = 215;
										p_208237 = procs_208080[chckIndx(i_208502, 0, procs_208080.length+0-1)-0];
										if (!(p_208237.hasOwnProperty('__karaxMarker__'))) {
										F.line = 217;
										var xx_208238 = p_208237.parentNode.getElementsByClassName("attachedType");
										if ((((xx_208238 != null ? xx_208238.length : 0) == 1) && (xx_208238[chckIndx(0, 0, xx_208238.length+0-1)-0].textContent == t_208214.textContent))) {
										F.line = 220;
			...
			L3: do {
				F.line = 186;
					...
					if (!(i_208531 < l_208532)) break L4;
						F.line = 115;
						k_207614 = colontmp__208529[chckIndx(i_208531, 0, colontmp__208529.length+0-1)-0];
						F.line = 116;
...
function groupBy(value_208351) {
	...
	framePtr = F;
		...
		F.line = 242;
		tt_208373 = tt_208373.kids[chckIndx(0, 0, tt_208373.kids.length+0-1)-0];
		F.line = 244;
		var types_208390 = [[]];
		F.line = 245;
		var procs_208407 = [[]];
...
function nsuToLowerAsciiChar(c_195780) {
	...
	framePtr = F;
		if ((ConstSet2[c_195780] != undefined)) {
		F.line = 222;
		...
		L1: do {
			F.line = 49;
				...
				if (!((str_index_206085 < (str_206073 != null ? str_206073.length : 0)) && (pat_index_206087 < (pattern_206072 != null ? pattern_206072.length : 0)))) break L2;
					L3: do {
						F.line = 51;
						var pattern_char_206095 = nsuToLowerAsciiChar(pattern_206072.charCodeAt(chckIndx(pat_index_206087, 0, pattern_206072.length+0-1)-0));
						F.line = 52;
						var str_char_206096 = nsuToLowerAsciiChar(str_206073.charCodeAt(chckIndx(str_index_206085, 0, str_206073.length+0-1)-0));
						...
						F.line = 67;
						score_206089 = ((Math.floor((5.0000000000000000e-01 * score_206089)))|0);
						F.line = 68;
						pat_index_206087 = 0;
						F.line = 69;
						str_index_206085 = addInt(str_index_206085, 1);
						...
						case 5:
							...
							F.line = 91;
							var next_pattern_char_206172 = nsuToLowerAsciiChar(pattern_206072.charCodeAt(chckIndx(addInt(pat_index_206087, 1), 0, pattern_206072.length+0-1)-0));
							F.line = 92;
							var next_str_char_206173 = nsuToLowerAsciiChar(str_206073.charCodeAt(chckIndx(addInt(str_index_206085, 1), 0, str_206073.length+0-1)-0));
							F.line = 95;
						...
						case -3:
							F.line = 103;
							if (!((ConstSet6[str_206073.charCodeAt(chckIndx(subInt(str_index_206085, 1), 0, str_206073.length+0-1)-0)] != undefined))) Tmp5 = true; else {								if (!(ConstSet7[str_206073.charCodeAt(chckIndx(subInt(str_index_206085, 1), 0, str_206073.length+0-1)-0)] != undefined)) Tmp6 = false; else {									Tmp6 = (ConstSet8[str_206073.charCodeAt(chckIndx(str_index_206085, 0, str_206073.length+0-1)-0)] != undefined);								}								Tmp5 = Tmp6;							}							var is_leading_char_206211 = Tmp5;
...
function dosearch_208554(value_208556) {
    ...
    stuff_208563 = doc.documentElement;
		...
		F.line = 286;
		db_208535[0] = nimCopy(null, stuff_208563.getElementsByClassName("reference"), NTI88305);
		F.line = 287;
			...
			L2: do {
				F.line = 186;
					...
					if (!(i_209045 < l_209046)) break L3;
						F.line = 288;
						ahref_208814 = db_208535[0][chckIndx(i_209045, 0, db_208535[0].length+0-1)-0];
						F.line = 289;
			...
			L5: do {
				F.line = 2737;
					...
					if (!(i_209053 < colontmp__209052)) break L6;
						...
						L7: do {
							F.line = 295;
							var c_208860 = contents_208537[0][chckIndx(i_208859, 0, contents_208537[0].length+0-1)-0];
							...
							if (matched_208862) {
							F.line = 303;
							if (matches_208846 != null) { matches_208846.push({Field0: db_208535[0][chckIndx(i_208859, 0, db_208535[0].length+0-1)-0], Field1: score_208861}); } else { matches_208846 = [{Field0: db_208535[0][chckIndx(i_208859, 0, db_208535[0].length+0-1)-0], Field1: score_208861}]; };
							}
			...
			L9: do {
				F.line = 2737;
					...
					if (!(i_209059 < colontmp__209058)) break L10;
						...
						i_208926 = i_209059;
						F.line = 307;
						matches_208846[chckIndx(i_208926, 0, matches_208846.length+0-1)-0]["Field0"].innerHTML = matches_208846[chckIndx(i_208926, 0, matches_208846.length+0-1)-0]["Field0"].getAttribute("data-doc-search-tag");
						F.line = 308;
						add_207085(ul_208825, tree_207020(makeNimstrLit("LI"), [matches_208846[chckIndx(i_208926, 0, matches_208846.length+0-1)-0]["Field0"]]));
						F.line = 2739;
